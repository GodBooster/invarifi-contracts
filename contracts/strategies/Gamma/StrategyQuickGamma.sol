...
contract StrategyQuickGamma is StratFeeManagerAccessableInitializable {
    ...
    IAlgebraQuoter public constant quoter =
        IAlgebraQuoter(0xa15F0D7377B2A0C0c10db057f641beD21028FC89);
    ...
    function addLiquidity() internal {
        ...
        (, uint amount0End) = gammaProxy().getDepositAmount(
            want,
            lpToken1,
            lp1Bal
        );
    ...
    function quoteAddLiquidity() internal returns (uint toLp0, uint toLp1) {
        ...
        if (isFastQuote) {
            ...
            uint sqrtPriceX96 = IAlgebraPool(IAlgebraPool(want).pool())
                .globalState();
