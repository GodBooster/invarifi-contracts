...
contract StrategyMVX is StratFeeManagerInitializable {
    ...
    function chargeFees(address callFeeRecipient) internal {
        ...
        uint256 batcherFeeAmount = feeBal * fees.batcher / DIVISOR;
    ...
    function retireStrat() external {
        ...
        IVault.StratCandidate memory candidate = IVault(vault).stratCandidate();
    ...
    function acceptTransfer() external {
        address prevStrat = IVault(vault).strategy();
