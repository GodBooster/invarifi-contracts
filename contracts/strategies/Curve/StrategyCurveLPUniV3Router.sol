...
contract StrategyCurveLPUniV3Router is StratFeeManagerAccessableInitializable {
    ...
    function __StrategyCurveLPUniV3Router_init(
        address _want,
        address _gaugeFactory,
        address _gauge,
        address _pool,
        uint[] calldata _params, // [poolSize, depositIndex, useUnderlying, useMetapool]
        bytes[] calldata _paths, // [crvToNativePath, nativeToDepositPath]
    ...
    function initialize(
        ...
        __StrategyCurveLPUniV3Router_init(
            _want,
            _gaugeFactory,
            _gauge,
            _pool,
