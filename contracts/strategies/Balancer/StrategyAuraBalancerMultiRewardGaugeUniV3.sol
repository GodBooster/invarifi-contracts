...
contract StrategyAuraBalancerMultiRewardGaugeUniV3 is StratFeeManagerAccessableInitializable, IBalancerAuraStrategy {
    ...
    event ChargedFees(uint256 indexed callFees, uint256 indexed batcherFees, uint256 indexed strategistFees);
    ...
    function isComposable() external pure returns (bool) {
        return false;
    }
