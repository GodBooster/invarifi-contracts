...
contract StrategyStargateArbNative is StratFeeManagerAccessableInitializable {
    ...
    function addLiquidity() internal {
        ...
        uint256 toWant = address(this).balance;
        IStargateRouterETH(stargateRouter).addLiquidityETH{value: toWant}();
    }
