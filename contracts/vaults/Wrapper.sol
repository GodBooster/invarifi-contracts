...
/**
 * @title Wrapper ERC-4626
 * @author kexley
 * @notice Implementation for an ERC-4626 wrapper of a Vault
 * @dev Wrapped Vault tokens can be minted by deposit of the underlying asset or by 
 * wrapping Vault tokens in a 1:1 ratio. Wrapped Vault tokens can either be unwrapped
 * for an equal number of Vault tokens or redeemed for the underlying asset
 */
contract Wrapper is ERC4626Upgradeable {
    ...
    /**
     * @notice Initializes an ERC-4626 wrapper for a Vault token
