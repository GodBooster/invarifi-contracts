...
import "../VelodromeOpLpHelper.sol";

contract AerodromeUniV2LpHelper is VelodromeOpLpHelper, LpHelperUniV2BaseBase {
  ...
  constructor(
    ...
    address _ac
  ) VelodromeOpLpHelper(_earnConfiguration, _uniswapV2Router, _ac) {}
