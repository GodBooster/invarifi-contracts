...
contract BalancerAuraLpHelper is LpHelperBase {
        ...
        returns (address[] memory swapTokens, uint256[] memory swapTokenAmount)
    {
        ...
        swapTokens[0] = IBalancerAuraStrategy(strategy).getNative();
    ...
    {
        address balancerRouter = StrategyAuraMainnet(strategy).unirouter();
