...
// File: contracts/zap/IUniswapV2Pair.sol
...
// File: contracts/zap/Babylonian.sol
...
// File: contracts/zap/SafeMath.sol
...
// File: contracts/zap/Address.sol
...
// File: contracts/zap/SafeERC20.sol
...
// File: contracts/zap/LowGasSafeMath.sol
...
// File: contracts/zap/IUniswapV2Router01.sol
...
// File: contracts/zap/IUniswapV2Router02.sol
...
contract UniV2Zap {
    ...
    function beefOut (address _vault, uint256 withdrawAmount) external {
        (IVaultV6 vault, IUniswapV2Pair pair) = _getVaultPair(_vault);
    ...
    function beefOutAndSwap(address _vault, uint256 withdrawAmount, address desiredToken, uint256 desiredTokenOutMin) external {
        (IVaultV6 vault, IUniswapV2Pair pair) = _getVaultPair(_vault);
    ...
    function _getVaultPair (address _vault) private view returns (IVaultV6 vault, IUniswapV2Pair pair) {
        vault = IVaultV6(_vault);
