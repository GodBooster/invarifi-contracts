...
contract FeeBatchV2 is Initializable, OwnableUpgradeable {
    ...
    function initialize(
        ...
        wNativeToCuberaRoute = [_wNative, _cubera];
    }
    ...
    function harvest() public {
        ...
        if (routerInitialized) {
            ...
            IUniswapRouter(unirouter).swapExactTokensForTokens(treasuryHalf, 0, wNativeToCuberaRoute, treasury, block.timestamp);
        } else {
