...
contract ChainVaultsTest is Test {
    ...
    // address book data
    AddressBook.Platform addressBook;
    ...
    function setUp() public {
        ...
        addressBook = ab.getPlatformConfig(chain);
    }
...
//        assertGt(callRewards, 0, "Expected callRewards > 0");
    ...
    function test_correctOwnerAndKeeper() external {
        assertEq(vault.owner(), addressBook.vaultOwner, "Wrong vault owner.");
        assertEq(strategy.owner(), addressBook.strategyOwner, "Wrong strategy owner.");
        assertEq(strategy.keeper(), addressBook.keeper, "Wrong keeper.");
    }
