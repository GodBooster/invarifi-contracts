...
contract AddressBookTest is Test {
    ...
    function test_PlatformConfig_ethereum() external {
        AddressBook.Platform memory config = ab.getPlatformConfig("ethereum");
    ...
    function test_PlatformConfig_bsc() external {
        AddressBook.Platform memory config = ab.getPlatformConfig("bsc");
