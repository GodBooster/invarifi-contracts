...
import "../../../contracts/strategies/Balancer/StrategyAuraGyroMainnet.sol";
import "../../../contracts/strategies/Balancer/BalancerStructs.sol";
...
contract StrategyAuraGyroTest is Test {
    ...
    function routes() public view returns (
        ...
        BalancerStructs.BatchSwapStruct[] memory _auraToNativeRoute,
        ...
        _outputToNativeRoute = new BalancerStructs.BatchSwapStruct[](1);
        _outputToNativeRoute[0] = BalancerStructs.BatchSwapStruct({
            poolId: 0x5c6ee304399dbdb9c8ef030ab642b10820db8f56000200000000000000000014,
            assetInIndex: 0,
            assetOutIndex: 1
        });

        _nativeToLp0Route = new BalancerStructs.BatchSwapStruct[](1);
        _nativeToLp0Route[0] = BalancerStructs.BatchSwapStruct({
            poolId: 0x93d199263632a4ef4bb438f1feb99e57b4b5f0bd0000000000000000000005c2,
            assetInIndex: 0,
            assetOutIndex: 1
        });

        _lp0ToLp1Route = new BalancerStructs.BatchSwapStruct[](1);
        _lp0ToLp1Route[0] = BalancerStructs.BatchSwapStruct({
            poolId: 0x93d199263632a4ef4bb438f1feb99e57b4b5f0bd0000000000000000000005c2,
            assetInIndex: 0,
            assetOutIndex: 1
        });

        _auraToNativeRoute = new BalancerStructs.BatchSwapStruct[](1);
        _auraToNativeRoute[0] = BalancerStructs.BatchSwapStruct({
