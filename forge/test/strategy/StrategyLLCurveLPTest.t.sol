...
import {StratFeeManager, StrategyLLCurveLP} from "contracts/strategies/StakeDAO/StrategyLLCurveLP.sol";
...
contract StrategyLLCurveLPTest is Test {
    ...
    address feeConfig = 0xDC1dC2abC8775561A6065D0EE27E8fDCa8c4f7ED;
    ...
    function setUp() public {
        ...
        StratFeeManager.CommonAddresses memory commonAddresses = StratFeeManager.CommonAddresses({
            ...
            feeRecipient: OldStrategy.feeRecipient(),
            feeConfig: feeConfig
        });
