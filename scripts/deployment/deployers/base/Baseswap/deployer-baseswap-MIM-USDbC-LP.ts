...
export const getBaseswap_MIM_USDbC_LPParams = (commonParameters: CommonAddressesAccessableStruct) =>
  [
    "0x36A3483353B89CDBa4D7e4D1a81E3CEe15947eD1",
...
// eslint-disable-next-line camelcase
export class BaseBaseswap_MIM_USDbC_LPDeployer extends VaultDeployer<
  StrategyBaseSwap,
  // eslint-disable-next-line camelcase
  StrategyBaseSwap__factory,
...
> {
  ...
  override rawVaultName() {
    return "BASE Baseswap MIM-USDbC LP";
  }
  ...
  override defaultStrategyParams(
    ...
    return getBaseswap_MIM_USDbC_LPParams(commonParameters);
  }

  override async metadata(): Promise<VaultMetadata> {
    return this.withDefaultMetadata({
      id: "baseswap-mim-usdbc",
      name: "MIM-USDbC LP",
      token: "MIM-USDbC LP",
      tokenProviderId: "baseswap",
      oracle: "lps",
      oracleId: "baseswap-mim-usdbc",
      status: "active",
      platformId: "baseswap",
      assets: ["MIM", "USDbC"],
      risks: [
      ...
      strategyTypeId: "lp",
      addLiquidityUrl:
        "https://baseswap.fi/add/0xd9aAEc86B65D86f6A7B5B1b0c42FFA531710b6CA/0x4A3A6Dd60A34bB2Aba60D73B4C88315E9CeB6A3D",
      removeLiquidityUrl:
        "https://baseswap.fi/remove/0xd9aAEc86B65D86f6A7B5B1b0c42FFA531710b6CA/0x4A3A6Dd60A34bB2Aba60D73B4C88315E9CeB6A3D",
  ...
  // eslint-disable-next-line camelcase
  override async deployStrategyMaster(): Promise<BaseBaseswap_MIM_USDbC_LPDeployer> {
    const master = await this._deployStrategyMaster();

    return new BaseBaseswap_MIM_USDbC_LPDeployer(this.hre, this.networkConfig, {
  ...
  // eslint-disable-next-line camelcase
  override async deployStrategyClone(): Promise<BaseBaseswap_MIM_USDbC_LPDeployer> {
