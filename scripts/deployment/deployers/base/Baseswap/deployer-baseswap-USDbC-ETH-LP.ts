...
export const getBaseswap_USDbC_ETH_LPParams = (commonParameters: CommonAddressesAccessableStruct) =>
  [
    "0x41d160033C222E6f3722EC97379867324567d883",
    "0x34688C3E5AAD119851D5dc6AEb01Bf6DEA746eE7",
...
// eslint-disable-next-line camelcase
export class BaseBaseswap_USDbC_ETH_LPDeployer extends VaultDeployer<
  StrategyBaseSwap,
  // eslint-disable-next-line camelcase
  StrategyBaseSwap__factory,
...
> {
  ...
  override rawVaultName() {
    return "BASE Baseswap USDbC-ETH LP";
  }
  ...
  override defaultStrategyParams(
    ...
    return getBaseswap_USDbC_ETH_LPParams(commonParameters);
  }
  ...
  override async metadata(): Promise<VaultMetadata> {
    return this.withDefaultMetadata({
      ...
      strategyTypeId: "lp",
      addLiquidityUrl:
        "https://baseswap.fi/add/0x4200000000000000000000000000000000000006/0xd9aAEc86B65D86f6A7B5B1b0c42FFA531710b6CA",
      removeLiquidityUrl:
        "https://baseswap.fi/remove/0x4200000000000000000000000000000000000006/0xd9aAEc86B65D86f6A7B5B1b0c42FFA531710b6CA",
  ...
  // eslint-disable-next-line camelcase
  override async deployStrategyMaster(): Promise<BaseBaseswap_USDbC_ETH_LPDeployer> {
    const master = await this._deployStrategyMaster();

    return new BaseBaseswap_USDbC_ETH_LPDeployer(this.hre, this.networkConfig, {
  ...
  // eslint-disable-next-line camelcase
  override async deployStrategyClone(): Promise<BaseBaseswap_USDbC_ETH_LPDeployer> {
