...
// #	Name	Type	Data
// 1	_want	address	0x6dA98Bde0068d10DDD11b468b197eA97D96F96Bc
// 2	_gauge	address	0x9f82A8b19804141161C582CfEa1b84853340A246
// 2	_commonAddresses.vault	address	0x54214d0C7772eb6f71ED4De294b3f809691005C9
...
// 8	_outputToLp1Route.from	address	0x7F5c764cBc14f9669B88837ca1490cCa17c31607
// 8	_outputToLp1Route.to	address	0x4200000000000000000000000000000000000006
// 8	_outputToLp1Route.factory	address	0x0000000000000000000000000000000000000000
// 9	_outputToLp1Route.from	address	0x4200000000000000000000000000000000000006
// 9	_outputToLp1Route.to	address	0x1F32b1c2345538c0c6f582fCB022739c4A194Ebb
// 9	_outputToLp1Route.factory	address	0x0000000000000000000000000000000000000000

export const getVelodromewstETH_ETHParams = (commonParameters: CommonAddressesAccessableStruct) =>
  [
...
// eslint-disable-next-line camelcase
export class OptimismVelodrome_wstETH_ETHDeployer extends VaultDeployer<
  StrategyCommonVelodromeGaugeV2,
  // eslint-disable-next-line camelcase
  StrategyCommonVelodromeGaugeV2__factory,
...
> {
  ...
  override rawVaultName() {
    return "Optimism Velodrome wstETH-ETH vLP V2";
  }
  ...
  override defaultStrategyParams(
    ...
    return getVelodromewstETH_ETHParams(commonParameters);
  }

  override async metadata(): Promise<VaultMetadata> {
    return this.withDefaultMetadata({
      id: "velodrome-v2-wsteth-weth",
      name: "wstETH-ETH vLP V2",
      token: "wstETH-ETH vLP V2",
      tokenProviderId: "velodrome",
      oracle: "lps",
      oracleId: "velodrome-v2-wsteth-weth",
      status: "active",
      ...
      strategyTypeId: "lp",
      buyTokenUrl:
        "https://velodrome.finance/swap?from=0x1f32b1c2345538c0c6f582fcb022739c4a194ebb&to=0x4200000000000000000000000000000000000006",
      addLiquidityUrl:
  ...
  // eslint-disable-next-line camelcase
  override async deployStrategyMaster(): Promise<OptimismVelodrome_wstETH_ETHDeployer> {
    const master = await this._deployStrategyMaster();

    return new OptimismVelodrome_wstETH_ETHDeployer(this.hre, this.networkConfig, {
  ...
  // eslint-disable-next-line camelcase
  override async deployStrategyClone(): Promise<OptimismVelodrome_wstETH_ETHDeployer> {
