...
// #	Name	Type	Data
// 1	_want	address	0x38EA452219524Bb87e18dE1C24D3bB59510BD783
// 2	_poolId	uint256	1
// 3	_chef	address	0xB0D502E938ed5f4df2E681fE6E419ff29631d62b
// 4	_stargateRouter	address	0x8731d54E9D02c286767d56ac03e8037C07e01e98
// 5	_routerPoolId	uint256	2
// 5	_commonAddresses.vault	address	0xe7f7f5b4E29504AeC833DAEeb913f4AA43222DcC
...
// 14	_outputToNativeRoute	address	0xAf5191B0De278C7286d6C7CC6ab6BB8A73bA2Cd6
// 15	_outputToNativeRoute	address	0xfeBb0bbf162E64fb9D0dfe186E517d84C395f016
// 16	_outputToNativeRoute	address	0xA1697F9Af0875B63DdC472d6EeBADa8C1fAB8568
// 17	_outputToNativeRoute	address	0xdAC17F958D2ee523a2206206994597C13D831ec7
// 18	_outputToNativeRoute	address	0x79c58f70905F734641735BC61e45c19dD9Ad60bC
// 19	_outputToNativeRoute	address	0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2
// 20	_outputToDepositRoute	address	0xAf5191B0De278C7286d6C7CC6ab6BB8A73bA2Cd6
// 21	_outputToDepositRoute	address	0xfeBb0bbf162E64fb9D0dfe186E517d84C395f016
// 22	_outputToDepositRoute	address	0xA1697F9Af0875B63DdC472d6EeBADa8C1fAB8568
// 23	_outputToDepositRoute	address	0xdAC17F958D2ee523a2206206994597C13D831ec7

// eslint-disable-next-line camelcase
export const getStargateUSDT_LPParams = (commonParameters: CommonAddressesAccessableStruct) =>
  [
    "0x38EA452219524Bb87e18dE1C24D3bB59510BD783", // _want
    1, // _poolId
...
// eslint-disable-next-line camelcase
export class StargateUSDT_LPDeployer extends VaultDeployer<
  StrategyStargateBal,
  // eslint-disable-next-line camelcase
  StrategyStargateBal__factory,
...
> {
  ...
  override async metadata(): Promise<VaultMetadata> {
    return this.withDefaultMetadata({
      ...
      buyTokenUrl: "https://app.1inch.io/#/1/unified/swap/ETH/USDT",
      addLiquidityUrl: "https://stargate.finance/pool/USDT-ETH/add",
      removeLiquidityUrl: "https://stargate.finance/pool/USDT-ETH/remove",
  ...
  // eslint-disable-next-line camelcase
  override async deployStrategyMaster(): Promise<StargateUSDT_LPDeployer> {
    const master = await this._deployStrategyMaster();

    return new StargateUSDT_LPDeployer(this.hre, this.networkConfig, {
  ...
  // eslint-disable-next-line camelcase
  override async deployStrategyClone(): Promise<StargateUSDT_LPDeployer> {
